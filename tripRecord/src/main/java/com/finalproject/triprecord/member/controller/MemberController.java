...
public class MemberController {
	...
	public String login(@RequestParam("memberId") String id, @RequestParam("memberPwd") String pwd, @RequestParam("beforeURL") String beforeURL, HttpSession session, Model model) {
		Member m = new Member();
		m.setMemberId(id);
		m.setMemberPwd(pwd);
